...
class BrowserStackPlugin : Plugin<Project> {
    override fun apply(project: Project) {
        ...
        appExtension.applicationVariants.all {
            ...
            val downloadResultsTask = project.tasks.register(
                "download${variantName}TestsResults",
                DownloadEspressoTestsResultsTask::class.java,
            ...
            project.tasks.register(
                ...
                if (bsConfigExtension.downloadTestsResults) {
                    finalizedBy(downloadResultsTask.name)
                }
            }
